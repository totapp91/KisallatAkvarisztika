...
foreach($_ in $csv) {
    ...
    foreach($Image in $Images) {
        ...
        $result = $Image.FullName.Replace("C:\Users\attila.toth\Documents\Azure DevOps\Web development\KisallatAkvarisztika", "https://github.com/totapp91/KisallatAkvarisztika/raw/master")
